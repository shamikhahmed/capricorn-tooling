...
**Status:** ARCH-01 core ✅ (analyzer + schema + 16 fixtures). This document is the **fleet topology** map: how apps, hub, tooling, and shared contracts relate. Per-app interactive maps are ARCH-02…ARCH-05.
